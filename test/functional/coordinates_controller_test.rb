...
class CoordinatesControllerTest < ActionController::TestCase
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post :create, coordinate: { coordinate_number: @coordinate.coordinate_number, lat: @coordinate.lat, lat_center: @coordinate.lat_center, lng: @coordinate.lng, lng_center: @coordinate.lng_center }
    end
  ...
  test "should update coordinate" do
    put :update, id: @coordinate, coordinate: { coordinate_number: @coordinate.coordinate_number, lat: @coordinate.lat, lat_center: @coordinate.lat_center, lng: @coordinate.lng, lng_center: @coordinate.lng_center }
    assert_redirected_to coordinate_path(assigns(:coordinate))
  end
