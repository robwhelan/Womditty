...
:whats_missing_demographics, :user_id, :new_city_name, :cell_phone_reception, :email, :first_name, :last_name, :doctor_eye_care, :car_care, :good_bar_1, :good_bar_2, :good_bar_3
